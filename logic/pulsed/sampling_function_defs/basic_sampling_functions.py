...
class DoubleSin(SamplingBase):
    ...
    LOCALFIX Andrew: for backwards compatibility 11/12/2018
    """
    params = OrderedDict()
...
class TripleSinSum(SamplingBase):
    ...
    class NSinSum(SamplingBase):
        """
        Object representing a linear combination of N sines
        (Superposition of N sine waves; NOT normalized)

        fixme: this function is not implemented yet! is currently just a copy of 3sinsum
        """
