...
from core.module import Base, StatusVar, ConfigOption ## FROM DUMMY PULSER
...
class AWGSpectrumM4i6631x8(Base, PulserInterface):
        ...
        def __init__(self, config, **kwargs):
            ...
            self.amplitude_dict = {'a_ch1': 1.0, 'a_ch2': 1.0}
            self.offset_dict = {'a_ch1': 0.0, 'a_ch2': 0.0}
        ...
        def get_constraints(self):
            ...
            activation_config['config0'] = {'a_ch1', 'a_ch2', 'd_ch1', 'd_ch2', 'd_ch3'}
            activation_config['config1'] = {'a_ch1', 'a_ch2', 'd_ch1'}
            activation_config['config2'] = {'a_ch1', 'a_ch2', 'd_ch1', 'd_ch3'}
            ...
            #activation_config['config3'] = {'a_ch1', 'd_ch1', 'd_ch2'}
            ## Usage of only digital channels:
            #activation_config['config4'] = {'d_ch1', 'd_ch2', 'd_ch3'}
            ## Usage of only one analog channel:
            #activation_config['config5'] = {'a_ch1'}
            #activation_config['config6'] = {'a_ch2'}
            ## Usage of only the analog channels:
            #activation_config['config7'] = {'a_ch1', 'a_ch2'}
            #constraints.activation_config = activation_config
        ...
        def set_active_channels(self, ch=None):
            ...
            print('active_channel_set:', active_channel_set)
            print('get_constraints().activation_config.values():', self.get_constraints().activation_config.values())
